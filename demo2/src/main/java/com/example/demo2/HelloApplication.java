...
public class HelloApplication extends Application {
    ...
    public void start(Stage stage) {
        ...
        final Group group = new Group(createInstructions(),createScore(),label,shape_2,shape_3,shape_4,shape2,shape3,shape4,shape5,root);
    ...
    private Label createScore() {
        ...
        label.getChildren().add(labelScore);
        ...
        shape_1.translateXProperty().addListener(new ChangeListener<>() {
            @Override
